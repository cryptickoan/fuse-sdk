 ...
 */
export const getInterestRateModel = function (marketAddress, provider) {
    return __awaiter(this, void 0, void 0, function* () {
        const cTokenInterface = new Interface([
            "function interestRateModel() view returns (address)"
        ]);
        // Get interest rate model address from asset address
        const assetContract = new Contract(marketAddress, cTokenInterface, provider);
        // Get IRM address
        ...
        const runtimeBytecodeHash = keccak256(yield provider.getCode(interestRateModelAddress));
        let irm;
        ...
        yield irm.init(interestRateModelAddress, marketAddress, provider);
        return irm;
    });
};
