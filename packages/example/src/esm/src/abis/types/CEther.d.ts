...
export interface CEtherInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "initialize(address,address,string,string,uint256,uint256)", values: [string, string, string, string, BigNumberish, BigNumberish]): string;
    ...
    decodeFunctionResult(functionFragment: "initialize(address,address,string,string,uint256,uint256)", data: BytesLike): Result;
...
export interface CEther extends BaseContract {
    ...
    functions: {
        ...
        "initialize(address,address,string,string,uint256,uint256)"(comptroller_: string, interestRateModel_: string, name_: string, symbol_: string, reserveFactorMantissa_: BigNumberish, adminFeeMantissa_: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        ...
        liquidateBorrow(borrower: string, cTokenCollateral: string, overrides?: PayableOverrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        ...
        repayBorrowBehalf(borrower: string, overrides?: PayableOverrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        "initialize(address,address,string,string,uint256,uint256)"(comptroller_: string, interestRateModel_: string, name_: string, symbol_: string, reserveFactorMantissa_: BigNumberish, adminFeeMantissa_: BigNumberish, overrides?: CallOverrides): Promise<void>;
        interestRateModel(overrides?: CallOverrides): Promise<string>;
        isCEther(overrides?: CallOverrides): Promise<boolean>;
        isCToken(overrides?: CallOverrides): Promise<boolean>;
